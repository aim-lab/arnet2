...
```
python3 run_ArNet2.py --mode predict --input_file /path/to/your/input_file.csv [--model_name ArNet2 --config /path/to/config_file.yml --save_model_path /path/to/save/model]
```
Where:
