...
score = 'Fb-Score'
db_name_dict = {'UVAFDB': 'UVAF', 'JPAFDB': 'SHDB', 'RBAFDB': 'RBDB', 'CPSCDB': 'CPSC', 'AFDB': 'AFDB', 'LTAFDB': 'LTAFDB'}
...
country_of_origin = {'UVAF train': ' (USA)', 'UVAF test': ' (USA)', 'SHDB': ' (Japan)', 'RBDB': ' (Israel)', 'CPSC': ' (China)',
...
hypercomb = {"XGB": {'n_estimators': 453, 'max_depth': 2},
             "1D-CNN": {'n_filters_start': 104, 'len_sub_window': 4, 'dropout': 0.47459329380222043,
                        'n_hidden_start': 68},
             # "ArNet": {'time_history': 12, 'extract_level': 'dense_2', 'n_units': 22, 'dropout': 0.7194263073722404, 'learning_rate': 0.00010390447220815073, 'af_weight': 3},  # the best hypercomb for "ArNet", with 1D-CNN as feature extractor
