...
class RBAFDB_Parser(BaseParser):
    ...
    def __init__(self, window_size=60, load_on_start=True):
        ...
        self.excel_sheet_path_prometheus = cts.BASE_DIR / "AIMLab" / "Shany" / "databases" / self.name.lower() / "documentation" / "RBAF_Holter_Info_prometheus.xlsx"
        self.excel_sheet_path_mdclone = cts.BASE_DIR / "AIMLab" / "Shany" / "databases" / self.name.lower() / "documentation" / "RBAF_Holter_Info_mdclone.xlsx"
        self.excel_sheet_path = cts.BASE_DIR / "AIMLab" / "Shany" / "databases" / self.name.lower() / "documentation" / "RBAF_Holter_Info.xlsx"
