...
def propotional_T_test(model_1, model_2, set='test_all'):
    """
    Calculates the for proportions between model_1 and model_2 based on normal (z).
    :param model_1: str. name of the first model to test.
    :param model_2: str. name of the second model to test.
    :param set: The test set for which to fetch predictions for.
    :return: None.
    """
    # Load predictions per model per set.
    ...
    # Compute overall number of success and overall number probabilities per model.
...
def statistical_post_hoc_test(df, val_col_kruskal, val_col, group_col):
    # TODO: check the reviewers comment what was the purpose of this function.
    """
    Compute the Kruskal-Wallis H-test for independent samples.
    :param df:
    :param val_col_kruskal:
    :param val_col:
    :param group_col:
    :return:
    """
