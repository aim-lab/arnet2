...
bp_ecg_select_res = filtfilt(b_bas,a_bas,ecg_select_res); % double
...
output = struct(strcat('QS_',s),abs(QS), strcat('R_amp_m_',s),abs(R_amp_m) , strcat('R_amp_std_',s),abs(R_amp_std),...
    ...
    strcat('stdPamp_',s),abs(stdPamp), strcat('medSTvar1_',s), abs(medSTvar1) , strcat('medSTvar2_',s),abs(medSTvar2),...
